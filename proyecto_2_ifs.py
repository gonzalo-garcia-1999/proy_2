...
def lectura_if_boolean():
    print("Hola!")
    print(
        "En esta parte se te va a enseñar sobre las estructuras selectivas. Sin embargo, para entender que son las estructuras selectivas, se necesita entender que es un boolean. \n Una expresión booleana compara a dos factores y da una respuesta entre verdadero y falso dependiendo del resultado de la comparación.")
    print(
        " Algunos ejemplos de expresiones booleanas: \n mayor: a>b \n mayor o igual: a>=b \n menor: a<b \n menor o igual: a<=b \n igual: a==b \n no igual: a!=b")
    print(
        "También, pueden haber expresiones booleanas que comparen mas de dos propiedades de distintos elementos. Por ejemplo:\n a<b and a<c \n a==b or a==c \n ")
    print(
        "Además, se pueden utilizar expresiones aritmeticas con los booleanss, tal y como:\n a+b>c+d \n a*b==b*c \n a%c!=a%b")
    a = input()
    while a != "":
...
def lectura_estructura_selectiva():
    print("")
    print(
        "Ahora que ya dominaste las expresiones booleanas es momento de aprender que es una estructura selectiva. Estas son aquellas que evalúan una expresión,\n generalmente booleana, y a partir del resultado propuesto, se toma una o más decisiones. Esisten trs tipos las de slección simple, selección doble y selección múltiple ")
    print(
        "Una estructura selectiva simple es aquella que después de evaluar una conidición determina su valor (verdadero/falso) y, si el valor da verdadero entonces la condición se llevará a cabo")
    print("Por ejemplo:")
    print("")
    print("if a > 5:")
    ...
    print("")
    print(
        "Entonces, si a==6 se imprimiría la frase: este numero es mayor a 5, pero si a==4, no se imprimiría nada y la frase no se imprimiría")
    ...
    print("")
    print(
        "Ahora, se va a imprimir un ejemplo de una estructura selectiva doble. Esta tiene dos caracteristicas, la palabra if y la palabra else")
    print(
        "La palabra if denota e seguimiento de esa parte de la función si la condición es verdad. La palabra else denota el seguimiento de la función si la condición planteada \n en el if no es verdad ")
    print("Por ejemplo:")
    print("if a > 5:")
    print("""   print("este numero es mayor a 5")""")
    print("else:")
    ...
    print("")
    print(
        "Entonces, acá, si el numero es mayor a 5 pasaría por la condición if e imprimiría el texto (este numero es mayor a 5). \n Sin embargo, si el numero no es mayor a 5 se imprimiría la segunda frase (este numero no es mayor a 5")
    print(
        "Por ejemplo, si a = 4, entonces se imprimiría: este numero no es mayor a 5 pero, si a = 6, se imprimiría: este numero es mayor a 5. OJO: el bloque de else es siempre opcional")
    print("")
    print("")
    print(
        "Finalmente, existen las estructuras selectivas multiples.\n Estas existen cuando hay multiples caminos que un if puede recorer y hay varias opciones que se quieren que probar. Para esto se utiliza la palabra elif después de el primer if\n Por ejemplo: ")
    print("if a>5:")
    print("""   print("este numero es mayor a 5")""")
    print("elif 4<=a<=5:")
...
def lectura_función():
    print(
        "Una función es un conjunto de instrucciones que realizan alguna tarea y esta tarea va a invocar más de una vez un mismo programa.")
    ...
    print("")
    print(
        "Otro probelam que se puede encontrar con las funciones es la definición de las variables. Acá hay una función ara ilustrarlo:")
    print("")
    ...
    print("")
    print(
        "El problema de esta función es que los valores son muy específicos ya que la función solo funcionaría con los valores a y b. Además siempre va a imprimir el resultado, lo cual no siempre es útil")
    ...
    print("")
    print(
        "Ya que la variable lado esta afuera de los scopes de las otras funciones, se puede utilizar en ambas funciones y puede ser accedida por cualquier parte")
    print("Sino, se tendría que variar la variable lado a otra variable para la función cuadrado_area")
    return
def ejercicio_funciones():
    print(
        "Ahora, harás un pequeño quiz para ver si has comprendido el tema de funciones. Tienes que escribir el output de los siguientes códigos:")
    print("")
